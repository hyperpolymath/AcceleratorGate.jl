= Acceleratorgate.Jl — User Quickstart
:toc: preamble
...
[source,bash]
----
git clone https://github.com/hyperpolymath/AcceleratorGate.jl
...
* https://github.com/hyperpolymath/AcceleratorGate.jl/issues — report bugs
