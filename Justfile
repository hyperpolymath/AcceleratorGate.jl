...
# Justfile for AcceleratorGate.jl
...
doctor:
    @echo "Running diagnostics for AcceleratorGate.jl..."
...
help-me:
    @echo "=== AcceleratorGate.jl Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/AcceleratorGate.jl/issues/new"
    @echo ""
...
# LLM context dump
llm-context:
    @echo "Project: AcceleratorGate.jl"
